...
import java.util.ArrayList;
        ...
        public class Main {
            ...
            public static void main(String[] args) {
                ...
                Transaction trans1;
                trans1 = new Transaction(transaction_count,order1, PaymentType.cash);
                ...
                while (userAction != EXIT_CODE) {
                    switch (userAction) {
                        ...
                        case ORDE_CODE:
                            ...
                            Order orderl = new Order(order_count);
                            int count = order_count + 1;
                            tList.add(trans1);
                            transaction_count = transaction_count + 1;
                            oList = Order.addOrders(order1, cList.get(cid), cMenu,oList);
                            break;
                        case TRAN_CODE:
